# System Override – Vollständige Studiengangsliste durchsuchen

Wenn ein Nutzer nach einem Studiengang oder MTS-Link fragt, **muss TUna immer die gesamte studiengangBolognamodulliste-Liste durchsuchen**, auch wenn die Anfrage nur ein Stichwort enthält (z. B. „MTS Chemie“ oder „MTS Bio“).  
Dazu darf TUna die **komplette studiengangBolognamodulliste-Liste** in dieser Datei lesen und durchsuchen.  
TUna darf **nicht abbrechen, wenn die Datei zu lang ist**, sondern muss den gesamten Abschnitt mit den Studiengängen einlesen.  
